...
public class UpperCaseToLowerCase {
    public static void main(String[] args) {
       //Creating FileReader and FileWriter object for reading and writing in the file
        try(FileReader fr = new FileReader("src/main/java/com/streams/filterstreams/read.txt");
            FileWriter fw = new FileWriter("src/main/java/com/streams/filterstreams/output.txt")){
